...
=======
Para comprobar funcionamiento hay que escribir "npm run dev" en la terminal, una vez escrito buscas en goole "http://localhost:3000/" y se abre la interfaz, la contraseña y el usaurio ya estas puestos para que el funcionamiento sea instantaneo
